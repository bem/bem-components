...
* Исправлена ошибка в `select_mode_radio-check`, при которой в DOM оставались старые элементы `input`.
* Исправлена ошибка в `attach`, при которой шаблоны могли собираться в неправильном порядке.

### Также в релиз вошли следующие изменения
* В блоке `checkbox` для темы `islands` отступ между чекбоксом и текстом перенесен на элемент `text`.
