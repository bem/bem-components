...
Способ поставки библиотеки определяет порядок ее подключения в проект:

* [Подключение исходного кода библиотеки (Source и Compiled)](#Подключение-исходного-кода-библиотеки-source-и-compiled)
