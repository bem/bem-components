...
Для поддержки данного браузера необходимо подключить на страницу `es5-shim` и дополнительные файлы стилей с расширением `*.ie.styl`. Для этого следует добавить их в сборку (например, [так](https://github.com/bem/bem-components/blob/1f218c8ba10183fda21660e28cfbb280cd8cde54/.enb/make.js#L174) и в блоке `page` добавить условные комментарии как показано ниже:
...
История изменений с последующими версиями будет доступна на отдельной странице.
