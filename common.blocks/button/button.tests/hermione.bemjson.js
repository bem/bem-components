    ...
    content : [
        ...
        { tag : 'p', content : [
            {
                ...
                text : 'normal',
                cls : 'hermione-test-button-islands-enabled'
            },
            '&nbsp;&nbsp;&nbsp;',
            {
                block : 'button',
                ...
                text : 'normal',
                cls : 'hermione-test-button-islands-disabled'
            },
            '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;',
            {
                block : 'button',
                ...
                text : 'plain',
                cls : 'hermione-test-button-plain-enabled'
            },
            '&nbsp;&nbsp;&nbsp;',
            {
                block : 'button',
                ...
                text : 'plain',
                cls : 'hermione-test-button-plain-disabled'
            },
            '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;',
            {
                block : 'button',
                ...
                text : 'pseudo',
                cls : 'hermione-test-button-pseudo-enabled'
            },
            '&nbsp;&nbsp;&nbsp;',
            {
                block : 'button',
                ...
                text : 'pseudo',
                cls : 'hermione-test-button-pseudo-disabled'
            },
            '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;',
            {
                block : 'button',
                ...
                text : 'action',
                cls : 'hermione-test-button-action-enabled'
            },
            '&nbsp;&nbsp;&nbsp;',
            {
                block : 'button',
                ...
                text : 'action',
                cls : 'hermione-test-button-action-disabled'
            },
            '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;',
            {
                block : 'button',
                ...
                cls : 'hermione-test-button-radio-checked-disabled'
            }
        ] },
        ...
        { tag : 'p', content : ['s', 'm', 'l', 'xl']
            .reduce(function(prev, size, i, arr) {
                prev.push({
                    ...
                    text : 'size ' + size,
                    cls : 'hermione-test-button-size-' + size
                });
        ...
        */
        ...
        { tag : 'p', content : [
            {
                ...
                url : '#',
                text : 'default link',
                cls : 'hermione-test-button-islands-link-enabled'
            },
            '&nbsp;&nbsp;&nbsp;',
            {
                block : 'button',
                ...
                url : '#',
                text : 'disabled link',
                cls : 'hermione-test-button-islands-link-disabled'
            }
        ] },
        ...
        { tag : 'p', content : [
            {
                ...
                cls : 'hermione-test-button-islands-icon-enabled'
            },
            '&nbsp;&nbsp;&nbsp;',
            {
                block : 'button',
                ...
                cls : 'hermione-test-button-islands-icon-disabled'
            }
            /* TODO: tests are not implemented
            '&nbsp;&nbsp;&nbsp;',
            {
        ...
        { tag : 'p', content : {
            ...
            text : 'islands check',
            cls : 'hermione-test-button-islands-check'
        } },
        { tag : 'p', content : {
            block : 'button',
            mods : { theme : 'islands', size : 'm', view : 'plain', togglable : 'check' },
            text : 'plain check',
            cls : 'hermione-test-button-plain-check'
        } }
    ]
});
