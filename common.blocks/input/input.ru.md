...
| <a href="#type">type</a> | <code>String</code> | Тип текстового поля. |
| <a href="#required">required</a> | <code>String</code> | Устанавливает поле формы обязательным. |
...
Если поле незаполнено, браузер выведет предупреждение без отправки формы.
Вид и содержание предупреждения зависит от браузера и меняться пользователем не может.
