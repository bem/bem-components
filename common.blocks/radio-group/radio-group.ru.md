...
Модификатор `mode` управляет реакцией элементов радиогруппы на щелчок мыши, например, возможностью деактивации выбранного элемента. Доступен только при установленном модификаторе `radio-group_type_button`.
