...
| <a href=#text>text</a> | <code>String</code> | Задает значение раскрывающегося списка выбора в случае, если ни один из пунктов не отмечен. |
| <a href=#id>id</a> | <code>String</code> | Задает уникальный идентификатор селекта. |
| <a href=#options>options</a> | <code>BEMJSON</code> | Задает массив пунктов списка. |
| <a href=#textmaxwidth>textMaxWidth</a> | <code>String</code> | Устанавливает максимальную ширину кнопки селекта. |
| <a href=#optionsmaxheight>optionsMaxHeight</a> | <code>String</code> | Устанавливает максимальную высоту выпадающего списка. |
